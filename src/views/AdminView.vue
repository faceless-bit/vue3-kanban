                ...
                <TransitionGroup name="task-list">
                  ...
                  >
                    ...
                    <div class="task-actions">
                      ...
                      <button v-if="task.status !== 'done'" class="btn-action btn-done" title="完成" @click="moveTask(task.id, 'done')">
...
.btn-action:hover { border-color: var(--color-primary); color: var(--color-primary); background: rgba(13,148,136,0.1); }
