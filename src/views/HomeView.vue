  ...
  <div class="dashboard">
    ...
    <div class="progress-bar-wrap">
      <div class="progress-info">
        <span><AppIcon name="trending" :size="14" class="progress-icon" /> 完成进度</span>
    ...
    <div class="support-bar">
      <span class="support-text">喜欢这个看板？</span>
      <button class="support-link" @click="donateOpen = true">
        <AppIcon name="coffee" :size="14" /> 请开发者喝杯咖啡
      </button>
    </div>
          ...
          <div class="modal-card">
            ...
            <div class="modal-layout">
              ...
              <div class="modal-right">
                <h2><AppIcon name="coffee" :size="22" class="modal-title-icon" /> 请开发者喝杯咖啡</h2>
                <p class="modal-desc">每一份支持都会用于项目维护和改进，感谢你的认可。</p>
    ...
    <div class="add-task-card">
      <h3><AppIcon name="edit" :size="18" class="add-icon" /> 新建任务</h3>
...
.progress-icon { margin-right: 4px; vertical-align: -2px; }
...
.modal-title-icon { color: var(--color-warn); flex-shrink: 0; }
